...
<html lang="en">
<head>
    <title>Code coverage report for build/rc-sdk.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">build/</a> rc-sdk.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">88.28% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>2033/2303</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">73.84% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>824/1116</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">87.67% </span>
        <span class="quiet">Functions</span>
        <span class='fraction'>597/681</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.26% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>1944/2178</span>
      </div>
    </div>
  </div>
...
3975
3976
3977</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">(function webpackUniversalModuleDefinition(root, factory) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if(typeof exports === 'object' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof module === 'object')</span>
<span class="cstat-no" title="statement not covered" >		module.exports = factory(require("es6-promise"), require("pubnub"), require("dom-storage"), (<span class="fstat-no" title="function not covered" >function webpackLoadOptionalExternalModule() {</span> <span class="cstat-no" title="statement not covered" >try { <span class="cstat-no" title="statement not covered" >return require("xhr2"); </span>} catch(e) {} </span>}()));</span>
	else <span class="missing-if-branch" title="else path not taken" >E</span>if(typeof define === 'function' &amp;&amp; define.amd)
...
<span class="cstat-no" title="statement not covered" >		exports["RCSDK"] = factory(require("es6-promise"), require("pubnub"), require("dom-storage"), (<span class="fstat-no" title="function not covered" >function webpackLoadOptionalExternalModule() {</span> <span class="cstat-no" title="statement not covered" >try { <span class="cstat-no" title="statement not covered" >return require("xhr2"); </span>} catch(e) {} </span>}()));</span>
	else
<span class="cstat-no" title="statement not covered" >		root["RCSDK"] = factory(root["Promise"], root["PUBNUB"], root["localStorage"], root["XMLHttpRequest"]);</span>
...
var RCSDK = (function () {
    function RCSDK(options) {
        ...
        this.getPlatform()
            .setServer(options.server || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>
            .setCredentials(options.appKey || <span class="branch-1 cbranch-no" title="branch not covered" >'',</span> options.appSecret || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>;
    ...
    RCSDK.prototype.getPageVisibility = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return pageVisibility.$get(this.getContext()); </span>};
    ...
    RCSDK.prototype.getLanguageHelper = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return languageHelper.$get(this.getContext()); </span>};
    RCSDK.prototype.getLocationHelper = function () { return locationHelper.$get(this.getContext()); };
    RCSDK.prototype.getShippingMethodHelper = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return shippingMethodHelper.$get(this.getContext()); </span>};
    ...
    RCSDK.injections = {
        localStorage: (typeof (localStorage) !== 'undefined'
            ? localStorage
            : <span class="branch-1 cbranch-no" title="branch not covered" >__webpack_require__(43))</span>,
        Promise: typeof (Promise) !== 'undefined' ? <span class="branch-0 cbranch-no" title="branch not covered" >Promise </span>: (promise.Promise || promise),
        PUBNUB: pubnub,
...
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                return new (__webpack_require__(44))();</span>
            }
            catch (e4) { } // Node only
<span class="cstat-no" title="statement not covered" >            throw new Error("This browser does not support XMLHttpRequest.");</span>
        },
...
var __extends = (this &amp;&amp; this.__extends) || function (d, b) {
    for (var p in b) <span class="missing-if-branch" title="if path not taken" >I</span>if (b.hasOwnProperty(p)) <span class="cstat-no" title="statement not covered" >d[p] = b[p];</span>
...
var PubnubMock = (function (_super) {
    ...
    PubnubMock.prototype.receiveMessage = <span class="fstat-no" title="function not covered" >function (msg, channel) {</span>
<span class="cstat-no" title="statement not covered" >        this.emit('message-' + channel, msg, 'env', channel);</span>
    };
    return PubnubMock;
...
var Observable = (function () {
    function Observable(context) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof Observable))
<span class="cstat-no" title="statement not covered" >            throw new Error('Observable(): New operator was omitted');</span>
    ...
    Observable.prototype.on = function (events, callback) {
        var _this = this;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof events == 'string')
            events = [events];
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!events)
<span class="cstat-no" title="statement not covered" >            throw new Error('No events to subscribe to');</span>
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof callback !== 'function')
<span class="cstat-no" title="statement not covered" >            throw new Error('Callback must be a function');</span>
        var self = this;
    ...
    Observable.prototype.emit = function (event) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isOneTimeEventFired(event)) {
<span class="cstat-no" title="statement not covered" >            this.log.debug('Observable.emit(%s): One-time event has been fired already', event);</span>
    ...
    Observable.prototype.off = function (event, callback) {
        ...
        if (!event) {
            ...
            if (!callback) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.hasListeners(event))
<span class="cstat-no" title="statement not covered" >                    return this;</span>
                this.listeners[event].forEach(function (cb, i) {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (cb === callback)
...
var Utils = (function () {
    ...
    Utils.prototype.extend = function (targetObject, sourceObject) {
        ...
        var options, name, src, copy, copyIsArray, clone, target = arguments[0] || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> i = 1, length = arguments.length, deep = false;
        // Handle a deep copy situation
        if (typeof target === "boolean") {
            deep = target;
            // skip the boolean and the target
            target = arguments[i] || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
            i++;
        }
        // Handle case when target is a string or something (possible in deep copy)
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof target !== "object" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!this.isFunction(target))</span> {
<span class="cstat-no" title="statement not covered" >            target = {};</span>
        }
        for (; i &lt; length; i++) {
            // Only deal with non-null/undefined values
            <span class="missing-if-branch" title="else path not taken" >E</span>if ((options = arguments[i]) !== null) {
                // Extend the base object
                for (name in options) {
                    src = target[name];
                    copy = options[name];
                    // Prevent never-ending loop
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (target === copy) {
<span class="cstat-no" title="statement not covered" >                        continue;</span>
                    ...
                    if (deep &amp;&amp; copy &amp;&amp; (this.isPlainObject(copy) || (copyIsArray = this.isArray(copy)))) {
                        if (copyIsArray) {
                            copyIsArray = false;
                            clone = src &amp;&amp; this.isArray(src) ? src : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
                        }
                        else {
    ...
    Utils.prototype.forEach = function (object, cb) {
        for (var i in object) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!object.hasOwnProperty(i))
<span class="cstat-no" title="statement not covered" >                continue;</span>
            var res = cb(object[i], i);
            <span class="missing-if-branch" title="if path not taken" >I</span>if (res === false)
<span class="cstat-no" title="statement not covered" >                break;</span>
        ...
        queryString.split('&amp;').forEach(function (arg) {
            ...
            if (arg.indexOf('=') == -1) {
                ...
                if (key in argsParsed) {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (key in argsParsed &amp;&amp; !self.isArray(argsParsed[key]))
    ...
    Utils.prototype.argumentsToArray = function (args) {
        return Array.prototype.slice.call(args || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> 0);
    };
    ...
    Utils.prototype.isArray = function (obj) {
        return Array.isArray ? Array.isArray(obj) : <span class="branch-1 cbranch-no" title="branch not covered" >this.type(obj) === "array";</span>
    };
    ...
    Utils.prototype.isNaN = function (obj) {
        return obj === null || !rdigit.test(obj) || <span class="branch-2 cbranch-no" title="branch not covered" >isNaN(obj);</span>
    };
    Utils.prototype.type = function (obj) {
        return obj === null
            ? <span class="branch-0 cbranch-no" title="branch not covered" >String(obj)</span>
            : class2type[toString.call(obj)] || <span class="branch-1 cbranch-no" title="branch not covered" >"object";</span>
    };
    Utils.prototype.isPlainObject = function (obj) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.constructor &amp;&amp; !hasOwn.call(obj, "constructor") &amp;&amp; !hasOwn.call(obj.constructor.prototype, "isPrototypeOf")) {
<span class="cstat-no" title="statement not covered" >            return false;</span>
    ...
    Utils.prototype.poll = function (fn, interval, timeout) {
        ...
        interval = interval || <span class="branch-1 cbranch-no" title="branch not covered" >1000;</span>
...
var Log = (function () {
    function Log(context, console) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!console) {
<span class="cstat-no" title="statement not covered" >            console = {</span>
    ...
    Log.prototype.parseArguments = function (args) {
        args = this.utils.argumentsToArray(args);
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.addTimestamps)
<span class="cstat-no" title="statement not covered" >            args.unshift(new Date().toLocaleString(), '-');</span>
        return args;
    };
...
var XhrMock = (function () {
    ...
    XhrMock.prototype.send = function (data) {
        ...
        if (!currentResponse) {
            setTimeout(function () {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (_this.onerror)
        ...
        var res = currentResponse.response(this), Promise = this.context.getPromise(), onLoad = function (res) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (_this.getResponseHeader('Content-Type') == 'application/json')
                res = JSON.stringify(res);
            _this.responseText = res;
            setTimeout(function () {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (_this.onload)
                    _this.onload();
            }, 1);
        };
    ...
    XhrMock.prototype.abort = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        this.log.debug('XhrMock.destroy(): Aborted');</span>
    };
...
var Cache = (function () {
    ...
    Cache.prototype.clean = function () {
        for (var key in this.storage) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.storage.hasOwnProperty(key))
<span class="cstat-no" title="statement not covered" >                continue;</span>
...
var Context = (function () {
    ...
    Context.prototype.getPubnub = function () {
        return this.stubPubnub ? this.injections.pubnubMock.$get(this) : <span class="branch-1 cbranch-no" title="branch not covered" >this.getPubnubReal();</span>
    };
    ...
    Context.prototype.getLocalStorage = function () {
        ...
        return this.createSingleton('localStorage', function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof _this.injections.localStorage !== 'function') {
                return _this.injections.localStorage; // this is window.localStorage
            }
<span class="cstat-no" title="statement not covered" >            return new _this.injections.localStorage(); </span>// this is NPM dom-storage constructor
        });
    };
    ...
    Context.prototype.getXHR = function () {
        return (this.stubAjax ? this.injections.xhrMock.$get(this) : <span class="branch-1 cbranch-no" title="branch not covered" >this.injections.XHR())</span>;
    };
    return Context;
})();
...
var Helper = (function () {
    ...
    Helper.prototype.getContext = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return this.context;</span>
    };
    Helper.prototype.createUrl = <span class="fstat-no" title="function not covered" >function (options, id) {</span>
<span class="cstat-no" title="statement not covered" >        return '';</span>
    ...
    Helper.prototype.resetAsNew = <span class="fstat-no" title="function not covered" >function (object) {</span>
<span class="cstat-no" title="statement not covered" >        if (object) {</span>
<span class="cstat-no" title="statement not covered" >            delete object.id;</span>
<span class="cstat-no" title="statement not covered" >            delete object.uri;</span>
        }
<span class="cstat-no" title="statement not covered" >        return object;</span>
    ...
    Helper.prototype.saveRequest = function (object, options) {
        if (!object &amp;&amp; !(options &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >options.post </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >options.body)</span>))
            throw new Error('No Object');
        return this.utils.extend(options || {}, {
            method: (options &amp;&amp; options.method) || (this.isNew(object) ? 'POST' : <span class="branch-1 cbranch-no" title="branch not covered" >'PUT')</span>,
    ...
    Helper.prototype.deleteRequest = function (object, options) {
        ...
        return this.utils.extend(options || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> {
    ...
    Helper.prototype.nextPageExists = <span class="fstat-no" title="function not covered" >function (data) {</span>
<span class="cstat-no" title="statement not covered" >        return (data &amp;&amp; data.navigation &amp;&amp; ('nextPage' in data.navigation));</span>
    };
    /**
    ...
    Helper.prototype.index = function (array, getIdFn, gather) {
        ...
        array = array || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    ...
    Helper.prototype.merge = function (target, supplement, getIdFn, mergeItems) {
        ...
        supplement = supplement || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
var List = (function () {
    ...
    List.prototype.regexpFilter = <span class="fstat-no" title="function not covered" >function (obj, options) {</span>
<span class="cstat-no" title="statement not covered" >        if (!(options.condition instanceof RegExp))</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('Condition must be an instance of RegExp');</span>
<span class="cstat-no" title="statement not covered" >        return (options.condition.test(obj));</span>
    };
    /**
    ...
    List.prototype.filter = function (filterConfigs) {
        var _this = this;
        var self = this;
        filterConfigs = (filterConfigs || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.map(function (opt) {
...
<span class="fstat-no" title="function not covered" >    function PageVisibility(context) {</span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        _super.call(this, context);</span>
<span class="cstat-no" title="statement not covered" >        this.events = {</span>
            change: 'change'
        };
<span class="cstat-no" title="statement not covered" >        var hidden = "hidden", onchange = <span class="fstat-no" title="function not covered" >function (evt) {</span></span>
<span class="cstat-no" title="statement not covered" >            evt = evt || window.event;</span>
<span class="cstat-no" title="statement not covered" >            var v = 'visible', h = 'hidden', evtMap = {</span>
                focus: v, focusin: v, pageshow: v, blur: h, focusout: h, pagehide: h
            };
<span class="cstat-no" title="statement not covered" >            _this.visible = (evt.type in evtMap) ? evtMap[evt.type] == v : !document[hidden];</span>
<span class="cstat-no" title="statement not covered" >            _this.emit(_this.events.change, _this.visible);</span>
        };
<span class="cstat-no" title="statement not covered" >        this.visible = true;</span>
<span class="cstat-no" title="statement not covered" >        if (typeof document == 'undefined' || typeof window == 'undefined')</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        // Standards:
<span class="cstat-no" title="statement not covered" >        if (hidden in document)</span>
<span class="cstat-no" title="statement not covered" >            document.addEventListener("visibilitychange", onchange);</span>
        else <span class="cstat-no" title="statement not covered" >if ((hidden = "mozHidden") in document)</span>
<span class="cstat-no" title="statement not covered" >            document.addEventListener("mozvisibilitychange", onchange);</span>
        else <span class="cstat-no" title="statement not covered" >if ((hidden = "webkitHidden") in document)</span>
<span class="cstat-no" title="statement not covered" >            document.addEventListener("webkitvisibilitychange", onchange);</span>
        else <span class="cstat-no" title="statement not covered" >if ((hidden = "msHidden") in document)</span>
<span class="cstat-no" title="statement not covered" >            document.addEventListener("msvisibilitychange", onchange);</span>
        else <span class="cstat-no" title="statement not covered" >if ('onfocusin' in document)</span>
<span class="cstat-no" title="statement not covered" >            document.onfocusin = document.onfocusout = onchange;</span>
        else
<span class="cstat-no" title="statement not covered" >            window.onpageshow = window.onpagehide = window.onfocus = window.onblur = onchange;</span>
    }
    PageVisibility.prototype.isVisible = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return this.visible;</span>
    };
    return PageVisibility;
})(observable.Observable);
exports.PageVisibility = PageVisibility;
<span class="fstat-no" title="function not covered" >function $get(context) {</span>
<span class="cstat-no" title="statement not covered" >    return new PageVisibility(context);</span>
}
exports.$get = $get;
&nbsp;
&nbsp;
...
var Platform = (function (_super) {
    ...
    Platform.prototype.setCredentials = function (appKey, appSecret) {
        var apiKey = (appKey || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> + ':' + (appSecret || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (apiKey == ':')
<span class="cstat-no" title="statement not covered" >            return this;</span>
        this.apiKey = (typeof btoa == 'function') ? btoa(apiKey) : <span class="branch-1 cbranch-no" title="branch not covered" >new Buffer(apiKey).toString('base64');</span>
        return this;
    };
    Platform.prototype.getCredentials = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        var credentials = ((typeof atob == 'function')</span>
            ? atob(this.apiKey)
...
<span class="cstat-no" title="statement not covered" >        return {</span>
    ...
    Platform.prototype.setServer = function (server) {
        this.server = server || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
        return this;
    };
    ...
    Platform.prototype.getAuthURL = <span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >        options = options || {};</span>
<span class="cstat-no" title="statement not covered" >        return this.apiUrl('/restapi/oauth/authorize?' + this.utils.queryStringify({</span>
            'response_type': 'code',
    ...
    Platform.prototype.parseAuthRedirectUrl = <span class="fstat-no" title="function not covered" >function (url) {</span>
<span class="cstat-no" title="statement not covered" >        var qs = this.utils.parseQueryString(url.split('?').reverse()[0]), error = qs.error_description || qs.error;</span>
<span class="cstat-no" title="statement not covered" >        if (error) {</span>
<span class="cstat-no" title="statement not covered" >            var e = new Error(error);</span>
<span class="cstat-no" title="statement not covered" >            e.error = qs.error;</span>
...
<span class="cstat-no" title="statement not covered" >        return qs;</span>
    ...
    Platform.prototype.authorize = function (options) {
        ...
        var body = {
            ...
            "refresh_token_ttl": options.remember ? <span class="branch-0 cbranch-no" title="branch not covered" >this.refreshTokenTtlRemember </span>: this.refreshTokenTtl
        };
        <span class="missing-if-branch" title="else path not taken" >E</span>if (options.username) {
            body.grant_type = 'password';
            body.username = options.username;
            body.password = options.password;
            body.extension = options.extension || '';
        }
        else <span class="cstat-no" title="statement not covered" >if (options.code) {</span>
<span class="cstat-no" title="statement not covered" >            body.grant_type = 'authorization_code';</span>
<span class="cstat-no" title="statement not covered" >            body.code = options.code;</span>
<span class="cstat-no" title="statement not covered" >            body.redirect_uri = options.redirectUri;</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            return this.context.getPromise().reject(new Error('Unsupported authorization flow'));</span>
        }
...
<span class="cstat-no" title="statement not covered" >            _this.clearStorage()</span>
    ...
    Platform.prototype.refresh = function () {
        ...
        var refresh = new (this.context.getPromise())(function (resolve, reject) {
            ...
            setTimeout(function () {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!authData || !authData.refresh_token)
<span class="cstat-no" title="statement not covered" >                    return reject(new Error('Refresh token is missing'));</span>
                <span class="missing-if-branch" title="if path not taken" >I</span>if (Date.now() &gt; authData.refreshExpireTime)
<span class="cstat-no" title="statement not covered" >                    return reject(new Error('Refresh token has expired'));</span>
                if (!_this.isPaused())
                ...
                resolve(_this.authCall({
                    ...
                    post: {
                        ...
                        "refresh_token_ttl": _this.remember() ? <span class="branch-0 cbranch-no" title="branch not covered" >_this.refreshTokenTtlRemember </span>: _this.refreshTokenTtl
                    }
                }));
        ...
        return refresh.then(function (response) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (_this.clearCacheOnRefreshError)
                _this.clearStorage();
...
<span class="cstat-no" title="statement not covered" >            _this.resume()</span>
...
<span class="cstat-no" title="statement not covered" >            throw e;</span>
    ...
    Platform.prototype.forceAuthentication = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        this.setCache({</span>
...
<span class="cstat-no" title="statement not covered" >        return this;</span>
    ...
    Platform.prototype.apiCall = function (options) {
        ...
        return this.isAuthorized().then(function () {
            ...
            return _this.getRequest()
                .setOptions(options)
                .setHeader('Authorization', _this.getTokenType() + (token ? ' ' + token : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>)
                .send();
        }).catch(function (e) {
    ...
    Platform.prototype.apiUrl = function (url, options) {
        url = url || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
        options = options || {};
        ...
        if (options.addMethod || options.addToken)
            builtUrl += (url.indexOf('?') &gt; -1 ? <span class="branch-0 cbranch-no" title="branch not covered" >'&amp;' </span>: '?');
        if (options.addMethod)
            builtUrl += '_method=' + options.addMethod;
        if (options.addToken)
            builtUrl += (options.addMethod ? '&amp;' : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> + 'access_token=' + this.getToken();
        return builtUrl;
    };
...
var Request = (function (_super) {
    ...
    Request.prototype.isLoaded = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return !!this.xhr;</span>
    };
    Request.prototype.setOptions = function (options) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!('query' in options) &amp;&amp; options.get)
<span class="cstat-no" title="statement not covered" >            options.query = options.get;</span>
        if ('method' in options)
            this.method = options.method;
        <span class="missing-if-branch" title="else path not taken" >E</span>if ('url' in options)
            this.url = options.url;
        <span class="missing-if-branch" title="if path not taken" >I</span>if ('query' in options)
<span class="cstat-no" title="statement not covered" >            this.query = options.query;</span>
        if ('body' in options)
            this.body = options.body;
        <span class="missing-if-branch" title="if path not taken" >I</span>if ('headers' in options)
<span class="cstat-no" title="statement not covered" >            this.setHeaders(options.headers);</span>
        <span class="missing-if-branch" title="if path not taken" >I</span>if ('async' in options)
<span class="cstat-no" title="statement not covered" >            this.async = !!options.async;</span>
        return this;
    };
    /**
    ...
    Request.prototype.checkOptions = function () {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.url)
<span class="cstat-no" title="statement not covered" >            throw new Error('Url is not defined');</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'OPTIONS', 'HEAD'].indexOf(this.method) &lt; 0)
<span class="cstat-no" title="statement not covered" >            throw new Error('Method has wrong value');</span>
        return this;
    };
    Request.prototype.getEncodedBody = function () {
        if (this.method === 'GET')
            return null;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.body === 'string') {
<span class="cstat-no" title="statement not covered" >            return this.body;</span>
        }
        else if (this.isJson()) {
            return JSON.stringify(this.body);
        }
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.isUrlEncoded()) {
...
<span class="cstat-no" title="statement not covered" >            return this.body;</span>
    ...
    Request.prototype.send = function () {
        ...
        var responsePromise = new (this.context.getPromise())(function (resolve, reject) {
            _this.checkOptions();
            var xhr = _this.getXHR(), url = _this.url + (!!_this.query ? (<span class="branch-0 cbranch-no" title="branch not covered" >(_this.url.indexOf('?') &gt; -1 ? '&amp;' : '?') + _this.utils.queryStringify(_this.query))</span> : '');
            ...
            xhr.onerror = function (event) {
                var e = new Error('The request cannot be sent' + (event ? ' (' + event.toString() + ')' : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>);
                e.request = _this;
                e.response = null;
...
var Headers = (function () {
    ...
    Headers.prototype.setHeaders = <span class="fstat-no" title="function not covered" >function (headers) {</span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        this.utils.forEach(headers, <span class="fstat-no" title="function not covered" >function (value, name) {</span></span>
<span class="cstat-no" title="statement not covered" >            _this.setHeader(name, value);</span>
        });
<span class="cstat-no" title="statement not covered" >        return this;</span>
    };
    ...
    Headers.prototype.setContentType = <span class="fstat-no" title="function not covered" >function (contentType) {</span>
<span class="cstat-no" title="statement not covered" >        this.setHeader(Headers.contentType, contentType);</span>
<span class="cstat-no" title="statement not covered" >        return this;</span>
    };
    Headers.prototype.getContentType = function () {
        return this.getHeader(Headers.contentType) || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
    };
    Headers.prototype.isMultipart = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return this.isContentType(Headers.multipartContentType);</span>
    };
...
var Response = (function (_super) {
    ...
    function Response(context, status, statusText, body, headers) {
        ...
        _super.call(this, context);
        this.log = log.$get(context);
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof (body) === 'string') {
            body = body.replace(/\r/g, '');
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!headers) {
<span class="cstat-no" title="statement not covered" >                var tmp = body.split(Response.bodySeparator);</span>
<span class="cstat-no" title="statement not covered" >                headers = (tmp.length &gt; 1) ? tmp.shift() : {};</span>
<span class="cstat-no" title="statement not covered" >                body = tmp.join(Response.bodySeparator);</span>
            }
        }
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (status == 1223)
<span class="cstat-no" title="statement not covered" >            status = 204;</span>
        this.status = status;
        this.statusText = statusText;
        this.body = body;
        try {
            // Step 1. Parse headers
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof (headers) === 'string') {
                (headers || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>
                    .split('\n')
...
<span class="cstat-no" title="statement not covered" >                this.setHeaders(headers);</span>
            }
            // Step 1.1. JEDI proxy sometimes may omit Content-Type header
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.hasHeader(h.Headers.contentType))
<span class="cstat-no" title="statement not covered" >                this.setHeader(h.Headers.contentType, h.Headers.jsonContentType);</span>
            // Step 2. Parse body
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.isJson() &amp;&amp; !!this.body &amp;&amp; typeof (this.body) === 'string') {
                this.json = JSON.parse(this.body);
                this.data = this.json; // backwards compatibility
                if (!this.checkStatus())
                    this.error = new Error(this.getError());
            }
            else <span class="cstat-no" title="statement not covered" >if (this.isMultipart()) {</span>
                // Step 2.1. Split multipart response
<span class="cstat-no" title="statement not covered" >                var boundary = this.getContentType().match(/boundary=([^;]+)/i)[1], parts = this.body.split(Response.boundarySeparator + boundary);</span>
<span class="cstat-no" title="statement not covered" >                if (parts[0].trim() === '')</span>
<span class="cstat-no" title="statement not covered" >                    parts.shift();</span>
<span class="cstat-no" title="statement not covered" >                if (parts[parts.length - 1].trim() == Response.boundarySeparator)</span>
<span class="cstat-no" title="statement not covered" >                    parts.pop();</span>
                // Step 2.2. Parse status info
<span class="cstat-no" title="statement not covered" >                var statusInfo = new Response(this.context, this.status, '', parts.shift());</span>
                // Step 2.3. Parse all other parts
<span class="cstat-no" title="statement not covered" >                this.responses = parts.map(<span class="fstat-no" title="function not covered" >function (part, i) {</span></span>
<span class="cstat-no" title="statement not covered" >                    var status = statusInfo.data.response[i].status;</span>
<span class="cstat-no" title="statement not covered" >                    return new Response(_this.context, status, '', part);</span>
                });
<span class="cstat-no" title="statement not covered" >                this.data = this.responses; </span>// backwards compatibility
            }
            else {
<span class="cstat-no" title="statement not covered" >                this.data = this.body;</span>
            }
        }
        catch (e) {
<span class="cstat-no" title="statement not covered" >            this.log.error('Response.parseResponse(): Unable to parse data');</span>
<span class="cstat-no" title="statement not covered" >            this.log.error(e.stack || e);</span>
<span class="cstat-no" title="statement not covered" >            this.log.error(this.body);</span>
...
var Subscription = (function (_super) {
    ...
    Subscription.prototype.register = function (options) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isSubscribed()) {
<span class="cstat-no" title="statement not covered" >            return this.renew(options);</span>
        }
        else {
    ...
    Subscription.prototype.renew = function (options) {
        var _this = this;
        options = options || {};
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.events)
<span class="cstat-no" title="statement not covered" >            this.eventFilters = options.events;</span>
        this.clearTimeout();
        return new (this.context.getPromise())(function (resolve, reject) {
    ...
    Subscription.prototype.remove = <span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        options = this.utils.extend({</span>
            async: true
        }, options);
<span class="cstat-no" title="statement not covered" >        return new (this.context.getPromise())(<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (!_this.subscription || !_this.subscription.id)</span>
<span class="cstat-no" title="statement not covered" >                throw new Error('Subscription ID is required');</span>
<span class="cstat-no" title="statement not covered" >            resolve(_this.getPlatform().apiCall({</span>
                async: !!options.async,
                // hook and has to be synchronous
                method: 'DELETE',
                url: '/restapi/v1.0/subscription/' + _this.subscription.id
            }));
        }).then(<span class="fstat-no" title="function not covered" >function (ajax) {</span>
<span class="cstat-no" title="statement not covered" >            _this.unsubscribe()</span>
                .emit(_this.events.removeSuccess, ajax);
<span class="cstat-no" title="statement not covered" >            return ajax;</span>
        }).catch(<span class="fstat-no" title="function not covered" >function (e) {</span>
<span class="cstat-no" title="statement not covered" >            _this.emit(_this.events.removeError, e);</span>
<span class="cstat-no" title="statement not covered" >            throw e;</span>
        });
    };
...
<span class="cstat-no" title="statement not covered" >            return this;</span>
        ...
        this.pubnub.subscribe({
            ...
            message: <span class="fstat-no" title="function not covered" >function (message, env, channel) {</span>
<span class="cstat-no" title="statement not covered" >                _this.log.info('RC.core.Subscription: Incoming message', message);</span>
<span class="cstat-no" title="statement not covered" >                _this.notify(message);</span>
            },
            connect: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >                _this.log.info('RC.core.Subscription: PUBNUB connected');</span>
            }
        });
        return this;
    };
...
var Validator = (function () {
     ...
     * @deprecated
     */
    Validator.prototype.phone = <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
...
<span class="cstat-no" title="statement not covered" >                return [];</span>
<span class="cstat-no" title="statement not covered" >            return _this.utils.isPhoneNumber(value) ? [] : [new Error('Value has to be a valid US phone number')];</span>
        };
    };
...
var BlockedNumber = (function (_super) {
    ...
    BlockedNumber.prototype.validate = <span class="fstat-no" title="function not covered" >function (item) {</span>
<span class="cstat-no" title="statement not covered" >        return this.validator.validate([</span>
...
var Call = (function (_super) {
    ...
    Call.prototype.createUrl = function (options, id) {
        ...
        return '/account/~/' +
            (options.personal || options.extensionId ? ('extension/' + (options.extensionId || '~') + '/') : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> +
    ...
    Call.prototype.isInProgress = <span class="fstat-no" title="function not covered" >function (call) {</span>
<span class="cstat-no" title="statement not covered" >        return (call &amp;&amp; call.result == 'In Progress');</span>
    };
    Call.prototype.isAlive = <span class="fstat-no" title="function not covered" >function (call) {</span>
<span class="cstat-no" title="statement not covered" >        return (call &amp;&amp; call.availability == 'Alive');</span>
    };
    Call.prototype.isInbound = function (call) {
        return (call &amp;&amp; call.direction == 'Inbound');
    };
    Call.prototype.isOutbound = <span class="fstat-no" title="function not covered" >function (call) {</span>
<span class="cstat-no" title="statement not covered" >        return !this.isInbound(call);</span>
    };
    Call.prototype.isMissed = <span class="fstat-no" title="function not covered" >function (call) {</span>
<span class="cstat-no" title="statement not covered" >        return (call &amp;&amp; call.result == 'Missed');</span>
    };
    Call.prototype.isFindMe = <span class="fstat-no" title="function not covered" >function (call) {</span>
<span class="cstat-no" title="statement not covered" >        return (call &amp;&amp; call.action == 'FindMe');</span>
    };
     ...
     */
    Call.prototype.checkMergeability = <span class="fstat-no" title="function not covered" >function (outboundRingOutCall, inboundCall, options) {</span>
<span class="cstat-no" title="statement not covered" >        var getTime = <span class="fstat-no" title="function not covered" >function (dateString) {</span></span>
<span class="cstat-no" title="statement not covered" >            return (new Date(dateString)).getTime();</span>
        };
<span class="cstat-no" title="statement not covered" >        return ((!options.strict || outboundRingOutCall.action &amp;&amp; outboundRingOutCall.action.toLowerCase().indexOf('ringout') != -1) &amp;&amp;</span>
            // Check directions
    ...
    Call.prototype.combineCalls = <span class="fstat-no" title="function not covered" >function (outboundRingOutCall, inboundCall, options) {</span>
<span class="cstat-no" title="statement not covered" >        options = options || {};</span>
<span class="cstat-no" title="statement not covered" >        var result = [];</span>
<span class="cstat-no" title="statement not covered" >        outboundRingOutCall.hasSubsequent = true;</span>
<span class="cstat-no" title="statement not covered" >        if (options.merge) {</span>
<span class="cstat-no" title="statement not covered" >            outboundRingOutCall.duration = (outboundRingOutCall.duration &gt; inboundCall.duration) ? outboundRingOutCall.duration : inboundCall.duration;</span>
            // TODO Usually information from inbound call is more accurate for unknown reason
<span class="cstat-no" title="statement not covered" >            outboundRingOutCall.from = inboundCall.to;</span>
<span class="cstat-no" title="statement not covered" >            outboundRingOutCall.to = inboundCall.from;</span>
            // Push only one "merged" outbound call
<span class="cstat-no" title="statement not covered" >            result.push(outboundRingOutCall);</span>
        }
        else {
            // Mark next call as subsequent
<span class="cstat-no" title="statement not covered" >            inboundCall.subsequent = true;</span>
<span class="cstat-no" title="statement not covered" >            inboundCall.startTime = outboundRingOutCall.startTime; </span>// Needed for sort
            // Push both calls, first outbound then inbound
<span class="cstat-no" title="statement not covered" >            result.push(outboundRingOutCall);</span>
<span class="cstat-no" title="statement not covered" >            result.push(inboundCall);</span>
        }
<span class="cstat-no" title="statement not covered" >        return result;</span>
     ...
     */
    Call.prototype.processCalls = <span class="fstat-no" title="function not covered" >function (calls, options) {</span>
<span class="cstat-no" title="statement not covered" >        var processedCalls = [], callsToMerge = [], self = this;</span>
...
<span class="cstat-no" title="statement not covered" >            call.subsequent = false;</span>
<span class="cstat-no" title="statement not covered" >            call.hasSubsequent = false;</span>
            // Second cycle to find other leg
            // It is assumed that call is the outbound, secondCall is inbound
<span class="cstat-no" title="statement not covered" >            calls.some(<span class="fstat-no" title="function not covered" >function (secondCall) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (call === secondCall)</span>
<span class="cstat-no" title="statement not covered" >                    return false;</span>
<span class="cstat-no" title="statement not covered" >                if (self.checkMergeability(call, secondCall, options)) {</span>
                    // Push to result array merged call
<span class="cstat-no" title="statement not covered" >                    processedCalls = processedCalls.concat(self.combineCalls(call, secondCall, options));</span>
                    // Push to array calls that are merged
<span class="cstat-no" title="statement not covered" >                    callsToMerge.push(call);</span>
<span class="cstat-no" title="statement not covered" >                    callsToMerge.push(secondCall);</span>
...
<span class="cstat-no" title="statement not covered" >        calls.forEach(<span class="fstat-no" title="function not covered" >function (call) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (callsToMerge.indexOf(call) == -1)</span>
<span class="cstat-no" title="statement not covered" >                processedCalls.push(call);</span>
        });
<span class="cstat-no" title="statement not covered" >        return processedCalls;</span>
    };
    /**
    ...
    Call.prototype.getSignature = <span class="fstat-no" title="function not covered" >function (call) {</span>
<span class="cstat-no" title="statement not covered" >        var cleanup = <span class="fstat-no" title="function not covered" >function (phoneNumber) {</span></span>
<span class="cstat-no" title="statement not covered" >            return (phoneNumber || '').toString().replace(/[^0-9]/ig, '');</span>
        };
<span class="cstat-no" title="statement not covered" >        return call.direction + '|' + (call.from &amp;&amp; cleanup(call.from.phoneNumber)) + '|' + (call.to &amp;&amp; cleanup(call.to.phoneNumber));</span>
    };
    Call.prototype.mergePresenceCalls = function (presenceCalls, presence) {
        ...
        presenceCalls = this.merge(presenceCalls || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> activeCalls, this.getSessionId, true);
    ...
    Call.prototype.mergeAll = function (presenceCalls, calls, activeCalls) {
        ...
        var presenceAndCalls = this.merge(presenceCalls || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> calls || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> this.getSessionId, true);
        // Second, merge activeCalls into previous result
        return this.merge(presenceAndCalls, activeCalls || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> this.getSessionId, true);
    };
    return Call;
})(helper.Helper);
exports.Call = Call;
...
var Presence = (function (_super) {
    ...
    Presence.prototype.isAvailable = <span class="fstat-no" title="function not covered" >function (presence) {</span>
<span class="cstat-no" title="statement not covered" >        return presence &amp;&amp; presence.presenceStatus == 'Available';</span>
    };
...
var Contact = (function (_super) {
    ...
    Contact.prototype.createUrl = <span class="fstat-no" title="function not covered" >function (options, id) {</span>
<span class="cstat-no" title="statement not covered" >        options = options || {};</span>
<span class="cstat-no" title="statement not covered" >        var root = '/account/~/extension/' +</span>
            (options.extensionId ? options.extensionId : '~') +
            '/address-book';
<span class="cstat-no" title="statement not covered" >        if (options.sync)</span>
<span class="cstat-no" title="statement not covered" >            return root + '-sync';</span>
    ...
    Contact.prototype.getFieldValues = function (where, fields, asHash) {
        return fields.reduce(function (result, field) {
            if (where &amp;&amp; where[field]) {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (asHash) {
<span class="cstat-no" title="statement not covered" >                    result[field] = where[field];</span>
                }
                else {
            ...
            return result;
        }, asHash ? <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>: []);
    };
    Contact.prototype.getFullName = function (contact) {
        return this.getFieldValues(contact, this.nameFields).join(' ');
    };
    Contact.prototype.getEmails = <span class="fstat-no" title="function not covered" >function (contact, asHash) {</span>
<span class="cstat-no" title="statement not covered" >        return this.getFieldValues(contact, this.emailFields, asHash);</span>
    };
    ...
    Contact.prototype.getAddresses = <span class="fstat-no" title="function not covered" >function (contact, asHash) {</span>
<span class="cstat-no" title="statement not covered" >        return this.getFieldValues(contact, this.addressFields, asHash);</span>
    };
    ...
    Contact.prototype.match = function (contact, string, options) {
        ...
        var found = null;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!string)
<span class="cstat-no" title="statement not covered" >            return found;</span>
        var matchWith = function (value) {
            ...
            if (!transformed)
                return;
            var match = (options.strict ? <span class="branch-0 cbranch-no" title="branch not covered" >transformed == string </span>: transformed.indexOf(string) &gt; -1);
            if (match)
                found = value;
        };
        // Search in fields
...
var DeviceModel = (function (_super) {
    ...
    DeviceModel.prototype.createUrl = <span class="fstat-no" title="function not covered" >function (options, id) {</span>
<span class="cstat-no" title="statement not covered" >        return '/dictionary/device';</span>
    };
    return DeviceModel;
})(helper.Helper);
...
<span class="fstat-no" title="function not covered" >    function Language() {</span>
<span class="cstat-no" title="statement not covered" >        _super.apply(this, arguments);</span>
    }
    Language.prototype.createUrl = <span class="fstat-no" title="function not covered" >function (options, id) {</span>
<span class="cstat-no" title="statement not covered" >        return '/dictionary/language';</span>
    };
    return Language;
})(helper.Helper);
exports.Language = Language;
<span class="fstat-no" title="function not covered" >function $get(context) {</span>
<span class="cstat-no" title="statement not covered" >    return context.createSingleton('Language', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return new Language(context);</span>
    });
}
exports.$get = $get;
&nbsp;
...
var Message = (function (_super) {
    ...
    Message.prototype.createUrl = function (options, id) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.fax)
<span class="cstat-no" title="statement not covered" >            return root + '/fax';</span>
        if (options.sms)
            return root + '/sms';
        if (options.pager)
    ...
    Message.prototype.isOutbound = <span class="fstat-no" title="function not covered" >function (message) {</span>
<span class="cstat-no" title="statement not covered" >        return !this.isInbound(message);</span>
    };
    Message.prototype.isSMS = <span class="fstat-no" title="function not covered" >function (message) {</span>
<span class="cstat-no" title="statement not covered" >        return (message &amp;&amp; message.type == 'SMS');</span>
    };
    Message.prototype.isPager = <span class="fstat-no" title="function not covered" >function (message) {</span>
<span class="cstat-no" title="statement not covered" >        return (message &amp;&amp; message.type == 'Pager');</span>
    };
    Message.prototype.isVoiceMail = <span class="fstat-no" title="function not covered" >function (message) {</span>
<span class="cstat-no" title="statement not covered" >        return (message &amp;&amp; message.type == 'VoiceMail');</span>
    };
    Message.prototype.isFax = <span class="fstat-no" title="function not covered" >function (message) {</span>
<span class="cstat-no" title="statement not covered" >        return (message &amp;&amp; message.type == 'Fax');</span>
    };
    ...
    Message.prototype.isRead = <span class="fstat-no" title="function not covered" >function (message) {</span>
<span class="cstat-no" title="statement not covered" >        return (message.readStatus == 'Read');</span>
    };
    Message.prototype.setIsRead = <span class="fstat-no" title="function not covered" >function (message, isRead) {</span>
<span class="cstat-no" title="statement not covered" >        message.readStatus = (!!isRead) ? 'Read' : 'Unread';</span>
...
var PhoneNumber = (function (_super) {
    ...
    PhoneNumber.prototype.isSMS = <span class="fstat-no" title="function not covered" >function (phoneNumber) {</span>
<span class="cstat-no" title="statement not covered" >        return this.hasFeature(phoneNumber, 'SmsSender');</span>
    };
    ...
    PhoneNumber.prototype.reserve = <span class="fstat-no" title="function not covered" >function (phoneNumber, date) {</span>
<span class="cstat-no" title="statement not covered" >        phoneNumber.reservedTill = new Date(date).toISOString();</span>
    };
    PhoneNumber.prototype.unreserve = <span class="fstat-no" title="function not covered" >function (phoneNumber) {</span>
<span class="cstat-no" title="statement not covered" >        phoneNumber.reservedTill = null;</span>
    };
...
var Ringout = (function (_super) {
    ...
    Ringout.prototype.resetAsNew = <span class="fstat-no" title="function not covered" >function (object) {</span>
<span class="cstat-no" title="statement not covered" >        object = _super.prototype.resetAsNew.call(this, object);</span>
<span class="cstat-no" title="statement not covered" >        if (object) {</span>
<span class="cstat-no" title="statement not covered" >            delete object.status;</span>
        }
<span class="cstat-no" title="statement not covered" >        return object;</span>
    };
...
var Service = (function (_super) {
    ...
    Service.prototype.createUrl = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return '/account/~/service-info';</span>
    };
...
<span class="fstat-no" title="function not covered" >    function ShippingMethod() {</span>
<span class="cstat-no" title="statement not covered" >        _super.apply(this, arguments);</span>
    }
    /**
     * TODO Add or describe options http://jira.ringcentral.com/browse/SDK-3 id done
     */
    ShippingMethod.prototype.createUrl = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return '/dictionary/shipping-options';</span>
    };
    return ShippingMethod;
})(helper.Helper);
exports.ShippingMethod = ShippingMethod;
<span class="fstat-no" title="function not covered" >function $get(context) {</span>
<span class="cstat-no" title="statement not covered" >    return context.createSingleton('ShippingMethod', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return new ShippingMethod(context);</span>
    });
}
exports.$get = $get;
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = __WEBPACK_EXTERNAL_MODULE_43__;</span>
&nbsp;
/***/ },
/* 44 */
/***/ <span class="fstat-no" title="function not covered" >function(module, exports) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >if(typeof __WEBPACK_EXTERNAL_MODULE_44__ === 'undefined') {<span class="cstat-no" title="statement not covered" >var e = new Error("Cannot find module \"undefined\""); <span class="cstat-no" title="statement not covered" ></span>e.code = 'MODULE_NOT_FOUND'; <span class="cstat-no" title="statement not covered" ></span>throw e;}</span></span>
<span class="cstat-no" title="statement not covered" >module.exports = __WEBPACK_EXTERNAL_MODULE_44__;</span>
&nbsp;
/***/ }
/******/ ])
});
;
//# sourceMappingURL=rc-sdk.js.map</pre></td></tr>
</table></pre>
<div class='push'></div><!-- for sticky footer -->
</div><!-- /wrapper -->
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Nov 18 2015 15:52:59 GMT-0800 (PST)
</div>
</div>
